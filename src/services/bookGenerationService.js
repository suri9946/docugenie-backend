...
const mergeChaptersIntoDocument = ({ title, subject, chapters, outline, rawText, style }) => {
  ...
  return {
    ...
    introduction: `Welcome to this comprehensive ${(outline && outline.totalPages) || chapters.length * 50}-page resource on ${subject}. This material is structured for progressive learning.`,
    sections,
